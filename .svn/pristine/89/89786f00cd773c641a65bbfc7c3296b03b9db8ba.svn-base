...
public class IndexingJob extends NutchTool implements Tool {
  ...
  public void index(Path crawlDb, Path linkDb, List<Path> segments,
    ...
    while (iterator.hasNext()) {
      ...
      if(isSolr){
       ...
       try {
        ...
        if(luceneIndexDirStr == null){
          LOG.info("No lucene dir are defined in your nutch-site.xml, please set.");
          return;
        }else {
      ...
      LOG.info("Indexer:no Configuration are loaded, please set indexer-solr or indexer-lucene in nutch-site.xml");
    }
