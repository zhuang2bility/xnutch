...
import org.apache.nutch.util.Langdetect;
  ...
  private String identifyLanguage(Parse parse) {
    ...
    */
    ...
    if(isProfileLoad == false) {
      org.apache.nutch.ProfileLoader profileLoader = new ProfileLoader();
      List<String> profiles = null;
      try {
        profiles = profileLoader.profileLoader();
        try {
      ...
      try {
        ...
        detector.append(titleandcontent);
    ...
    return null;
    */
    Langdetect langdetect = null;
    String language = Langdetect.detect(titleandcontent);
    //isProfileLoad = true;
    return language;
